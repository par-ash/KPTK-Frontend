...
import { AreaChart, YAxis, ResponsiveContainer, XAxis, CartesianGrid, Tooltip, Area } from 'recharts'
        ...
        <div className='max-w-[1300px] w-full lg:w-[80%] px-[120px] px-[50px] lg:pl-[200px] xl:pl-[180px] py-[150px] relative flex items-center justify-center w-full' >
            <div className='flex flex-col justify-center m-auto items-center  w-full'>
                ...
                <div className='flex flex-col justify-center items-center self-center xl:self-start w-full'>
                    <div className='h-[46px] w-[46px] self-center xl:self-start'>
                        <Image src={"/$index.svg"} alt="$INDEX" width={100} height={100} />
                    </div>
                ...
                <div className='  mt-[20px] grid grid-cols-1 xl:grid-cols-[6fr_6fr] gap-[20px] w-full h-full'>
                    {/* Left */}
                    <div className='w-full max-w-[100%] xl:max-w-[550px] flex flex-col justify-center items-center mr-[20px]    sm:max-h-[670px]  h-full  '>
                        {/* Top */}
                        <div className='pt-[30px]  h-full w-full grid grid-row-[5_7] rounded-[10px] bg-[#302E3A]  '>

                            <div className='flex flex-col justify-center items-center md:flex-row md:justify-between items-center w-full h-full px-[20px]'  >
                                {/* Text */}
                                <div className='flex-col justify-center items-center'>
                                    <h6 className='text-[#7853F8] text-[46px]  font-bold'>$1,580.98</h6>
                                    <h6 className='text-[#F34242] text-[12px]  font-bold'>
                                        <span className='text-[#F34242]'>-$0.43 (+3.68%)</span>
                            ...
                            <div className='min-w-[200px] w-[100%]  h-[325px]   mt-[50px] '>
                ...
                {/* <AppFooter /> */}
                <div className='mt-[100px] xl:mt-[68px]  rounded-[10px]  p-[20px] border-solid border-[1px] border-[#EBEBEB1A] text-[16px]  w-full'>
                    <h6>Disclaimer :</h6><br />
                    <p>
